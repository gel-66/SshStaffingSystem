...
<tr>
<td align="right" > <a href="<%=basePath %>department_saveUI.action">添加</a></td>
</tr>
</table>
<br/>
...
<s:iterator value="list" var="d">
	<tr>
		...
		<td align="center"><a href="<%=basePath %>department_edit.action?did=<s:property value="#d.did"/>"><img src="<%=basePath %>images/edit.png"></a></td>
		<td align="center"><a href="<%=basePath %>department_delete.action?did=<s:property value="#d.did"/>"><img src="<%=basePath %>images/trash.gif"></a></td>
	</tr>
</s:iterator>
</tbody>
</table>
